...
<script>
import { getPayTypeUserCountAuditData } from '../../../api/audit/payTypeUserCount-audit';

export default {
  name: 'payType-userCount-audit-page',
