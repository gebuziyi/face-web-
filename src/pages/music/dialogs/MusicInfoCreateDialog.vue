<template>
  <!-- 创建音乐信息 -->
  <el-dialog :visible.sync="show" title="新增音乐信息" width="800px" @close="onDialogClose($refs.createForm)" :close-on-click-modal="false">
...
<script>
import { createMusicInfo } from '../../../api/music/music-info';
