<template>
  <div>
    <div class="tab-wrapper">
      <div class="publish">
        <h3>发布直播活动:</h3>
        <p class="desc">1. 点击前往<el-button type="text" @click="routeToLiveConsole" class="pd-left-1em"><i class="fa fa-desktop"></i>直播控制台</el-button>
        </p>
        <p class="desc">2. 在直播列表中选取要推荐的直播, 点击左下角[推荐]按钮</p>
        <p class="desc">3. 在弹窗中输入推荐语, 点击确定即可</p>
      </div>
      <h4>活动发布记录</h4>
      <!-- 查询表单 start-->
